...
INVALID_FORMAT_MESSAGE = "Sorry, only texts messages or stickers are allowed. Editing of messages are also not allowed."
START_MESSAGE = "Welcome to A Safe Space by Love, USP! Enter /register to register."
HELP_MESSAGE = "help message"
ALREADY_REGISTERED_MESSAGE = "already registered messsage"
REGISTRATION_CLARIFICATION_MESSAGE = "registration clarification message"
